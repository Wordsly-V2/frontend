...
- `/admin/path` shows totals, validation, seed-file clashes, the tree (units open to their lessons and items), and releases; Publish warns that archived items get retired (learners lose those cards), and "Make live" on an older release retires nothing.
