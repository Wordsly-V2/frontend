import { createMyWord, deleteMyWord, moveMyWord, updateMyWord } from "@/apis/words.api";
...
export const useWords = () => {
    ...
    return { mutationCreateMyWord, mutationUpdateMyWord, mutationDeleteMyWord, mutationMoveMyWord };
};